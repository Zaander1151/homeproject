...
**📘 Complete Build Guides Available!** Each beginner project now has a comprehensive step-by-step guide with:
- Detailed parts lists with Canadian pricing
- Component explanations and specifications
- Wiring diagrams and breadboard layouts
- Complete ESPHome configurations with explanations
- Troubleshooting guides for common issues
- Automation examples and enhancements
- Learning resources and next steps

**💻 [Set Up VS Code for ESPHome Development →](esphome-vscode-setup.md)**
Get a professional IDE experience with syntax highlighting, autocomplete, and one-click flashing. **Highly recommended!**

**Start with Project 1 (Blink LED) if you're new to ESP32!**
...
**📘 [Complete Build Guide →](projects/01-blink-led.md)**
...
**📘 [Complete Build Guide →](projects/02-temperature-humidity.md)**
...
**📘 [Complete Build Guide →](projects/03-smart-lamp.md)**
...
**📘 [Complete Build Guide →](projects/04-presence-detection.md)**
