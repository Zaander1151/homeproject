...
Complete requirements for building a functional ESP32/IoT development workbench.
...
#### Soldering Equipment
- [ ] **Soldering Iron** - Temperature controlled (60-80W)
...
- [ ] **Solder** - Leaded (easier) or lead-free
  - *Size:* 0.8mm or 1.0mm diameter
  - *Type:* 60/40 or 63/37 rosin core
  - **Cost:** $10-15

- [ ] **Soldering Stand** - Helps prevent burns and tip damage
...
#### Hand Tools
- [ ] **Wire Cutters** - Flush cut type
  - *Use:* Trimming component leads, cutting wires
  - **Cost:** $8-15

- [ ] **Wire Strippers** - Adjustable or multi-size
...
- [ ] **Bench Power Supply** - Variable DC (adjustable voltage/current)
...
- [ ] **ESP32-C3** (2-3 units) - Optional
  - *Advantages:* USB-C, smaller, cheaper
  - **Cost:** $3-5 each

- [ ] **M5Stack Atom** (optional, you already have 2)
  - *Use:* Compact projects, built-in LED, button
  - **Cost:** $10-15 each
...
- [ ] **LEDs** - Assorted colors, 5mm or 3mm
...
- [ ] **PIR Motion Sensor** - HC-SR501 (2-3 units)
  - **Cost:** $2-4 each
...
- [ ] **Light Sensor** - BH1750 I2C or photoresistor
  - **Cost:** $1-5
...
- [ ] **Micro-USB Cables** (5+ units)
  - *Must be:* Data cables, not charge-only
  - **Cost:** $1-3 each

- [ ] **USB-C Cables** (2-3 units, for newer boards)
  - **Cost:** $2-5 each
...
- [ ] **Heat-Resistant Mat** - Silicone soldering mat
...
- [ ] **3D Printer** - For enclosures and brackets
...
- [ ] **Component Tester** - LCR meter, transistor tester
  - **Cost:** $15-30
